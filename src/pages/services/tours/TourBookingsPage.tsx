  ...
  return (
    <div className="min-h-full w-full px-4 sm:px-6 lg:px-8 xl:px-12 py-6 bg-slate-50">
      ...
      <div className="mb-6 flex items-center justify-between">
        <div>
          <h1 className="text-2xl font-semibold text-slate-900 mb-2">Tour Bookings</h1>
          <p className="text-sm text-slate-600">Manage tour packages and customer bookings</p>
        </div>
        <Link
              ...
              {filteredBookings.map((booking) => (
                <tr key={booking.id} className="hover:bg-slate-50 transition-colors">
                  ...
                  <td className="px-6 py-4">
                    <div className="text-sm text-slate-900">{booking.tourName}</div>
                    <div className="text-xs text-slate-500">{booking.vehicle}</div>
                  </td>
                  <td className="px-6 py-4 whitespace-nowrap">
                    <div className="text-sm text-slate-900">{booking.startDate}</div>
                    <div className="text-xs text-slate-500">to {booking.endDate}</div>
                  </td>
                  ...
                  <td className="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                    <button className="text-ev-green hover:text-ev-green-dark">
                      View Details
                    </button>
                  </td>
                </tr>

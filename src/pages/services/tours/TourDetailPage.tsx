      ...
      <div className="w-full">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <div className="lg:col-span-2">
            <div className="bg-white dark:bg-slate-800 rounded-xl border border-slate-200 dark:border-slate-700 overflow-hidden flex flex-col h-[70vh] lg:h-[600px]">
              {/* Chat Header */}
              <div className="px-4 sm:px-6 py-4 border-b border-slate-200 dark:border-slate-700 bg-slate-50 dark:bg-slate-900">
              ...
              <div className="flex-1 overflow-y-auto p-4 sm:p-6 space-y-4">
                {messages.length === 0 ? (
                  ...
                  messages.map((message) => (
                    ...
                    >
                      <div
                        className={`max-w-[85%] sm:max-w-[70%] rounded-lg px-4 py-2 ${message.isOwn
              ...
              {/* Message Input */}
              <div className="px-4 sm:px-6 py-4 border-t border-slate-200 dark:border-slate-700 bg-slate-50 dark:bg-slate-900">
                <form onSubmit={handleSendMessage} className="flex flex-col sm:flex-row gap-2">
                  ...
                  <button
                    type="submit"
                    className="w-full sm:w-auto px-6 py-2 rounded-lg bg-ev-green text-white text-sm font-medium hover:bg-ev-green-dark"
                  >
                    Send
                  </button>
                </form>
